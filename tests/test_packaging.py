...
class PackagingContractTests(unittest.TestCase):
    def test_release_versions_are_synchronized(self) -> None:
        ...
        self.assertEqual("0.1.0-alpha.17", __release_version__)
    ...
    def test_wheel_and_sdist_include_published_schemas(self) -> None:
        ...
        self.assertIn(
            "pgextassure/schemas/pilot-package-1.0.schema.json",
            wheel_files,
        )
        self.assertIn(
            "pgextassure/schemas/admission-event-1.0.schema.json",
            wheel_files,
        )
        self.assertIn(
        ...
        self.assertIn(
            "pgextassure/schemas/pilot-acceptance-report-1.0.schema.json",
            wheel_files,
        )
        self.assertIn(
