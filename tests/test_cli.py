...
class CliContractTests(unittest.TestCase):
    def test_version_flag_reports_release_version(self) -> None:
        ...
        self.assertEqual("pgextassure 0.1.0-alpha.11\n", result.stdout)
    ...
    def test_sarif_output_is_valid_and_byte_deterministic(self) -> None:
        ...
        self.assertEqual("0.1.0-alpha.11", driver.get("semanticVersion"))
        self.assertEqual(
    ...
    def test_text_output_uses_product_display_name(self) -> None:
        ...
        self.assertEqual(0, result.returncode, result.stderr)
        self.assertTrue(
            result.stdout.startswith("PgExtAssure 0.1.0-alpha.11\n"),
            result.stdout,
        )
